...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(org-block-begin-line ((,class (:foreground ,blue-1 :background ,black-5))))  ;; :underline ,blue-1
   `(org-block-end-line ((,class (:foreground ,blue-1 :background ,black-5 :height 0.6))))
   ;; `(org-block-end-line ((,class (:overline ,blue-1 :underline nil :height 0.5 :extend t))))
