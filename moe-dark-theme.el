...
(let ((class '((class color) (min-colors 89)))
      ...
      (black-2-5 "#6c6c6c") (black-3 "#4e4e4e") (black-4 "#3a3a3a") (black-5 "#101010") (black-6 "#000000")
  ...
  (custom-theme-set-faces
   ...
   `(mode-line ((,class (:box nil :background ,black-3 :foreground ,white-2))))
   `(mode-line-inactive ((,class (:box nil :background ,black-4 :foreground ,white-3))))
   `(mode-line-buffer-id ((,class (:box nil :foreground ,blue-0 :background nil :bold t))))
   ...
   `(font-lock-comment-delimiter-face ((,class (:foreground ,black-2 :slant italic))))
   `(font-lock-comment-face ((,class (:foreground ,black-2 :slant italic))))
   ...
   `(org-ellipsis ((,class (:foreground ,black-2-5))))
   ...
   `(org-mode-line-clock ((,class (:foreground ,blue-1 :background nil :bold t))))
   ...
   ;; Flyspell faces
   `(flyspell-duplicate ((,class (:weight normal :underline (:color ,green-2 :style wave)))))
   `(flyspell-incorrect ((,class (:weight normal :underline (:color ,green-1 :style wave)))))
   ...
   ;; which-function-mode
   `(which-func ((,class (:foreground ,orange-2 :background nil))))
